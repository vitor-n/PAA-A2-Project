...
class GraphGenerator:
    ...
    def plot(self):
        ...
        pos = {i * self.num_cols + j: (j, -i) for i in range(self.num_rows) for j in range(self.num_cols)}
        ...
        nx.draw(self.graph, pos, edge_color=edge_colors, node_size=0, width=3, with_labels=False)
